/**
 * Competitions data and background gradients
 * Contains all competition information and their associated background gradients
 */

export const competitionBackgrounds = [
...
export const competitionsList = [
  ...
  },
  {
    ...
    desc: "Showcase your dance moves in this electrifying hybrid competition. Submit your 1-minute video online, and top 8 teams battle it out in the finals.",
    prizePool: "₹10,000",
  },
  {
    name: "Frames Ahoy",
    ...
    desc: "Design stunning user interfaces and experiences. Create high-fidelity prototypes using Figma or Adobe XD and showcase your design skills.",
    prizePool: "₹10,000",
  },
  {
    name: "BGMI",
  ...
  },
  {
    name: "Tekken",
    category: "Esports",
    tagline: "Fighting Championship",
    desc: "Battle it out in this classic fighting game tournament. Master your combos and emerge victorious in knockout competition.",
    prizePool: "₹5,000",
  },
];
