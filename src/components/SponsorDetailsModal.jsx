...
import { Crown, BarChart3, Megaphone, Sparkles, Instagram, Linkedin, Youtube, Users, Globe, Coins } from "lucide-react";
import {
    sponsorshipTiers,
    sponsorshipMetrics,
    sponsorshipPillars,
...
export function SponsorDetailsModal({ isOpen, onClose }) {
    ...
    return (
        <div className="sponsor-modal" onClick={handleClose}>
            <div className="sponsor-modal__content" onClick={(e) => e.stopPropagation()}>
                <button
                ...
                <header className="sponsor-modal__header">
                    ...
                    <p>Partner with NOESIS 2026 and reach India's next generation of builders</p>
                </header>

                <div className="sponsor-modal__layout">
                    {/* Vertical Sidebar Navigation */}
                    <aside className="sponsor-modal__sidebar" role="tablist" aria-label="Sponsorship information">
                        <button
                    ...
                    <div className="sponsor-modal__main">
                        <div className="sponsor-modal__body">
                            {activeTab === "tiers" && (
                                <div className="sponsor-modal__section" id="tiers-panel" role="tabpanel">
                                    <h3>Sponsorship Tiers</h3>
                                    <div className="sponsor-tiers-detailed">
                                        {sponsorshipTiers.map((tier) => {
                                            const IconComponent = tier.icon;
                                            return (
                                                <details key={tier.id} className="sponsor-tier-detail" open={tier.id === "title"}>
                                                    <summary className="sponsor-tier-detail__summary">
                                                        <div className="sponsor-tier-detail__header">
                                                            ...
                                                            <span className="sponsor-tier-detail__price">{tier.price}</span>
                                                            <span className="sponsor-tier-detail__benefit-count">{tier.benefits.length} Benefits</span>
                                                        </div>
                                                    </summary>
                                                    <div className="sponsor-tier-detail__content">
                                                        <ul>
                                                            {tier.benefits.map((benefit, idx) => (
                                                                <li key={`${tier.id}-benefit-${idx}`}>{benefit}</li>
                                                            ))}
                                                        </ul>
                                                    </div>
                                                </details>
                            ...
                            {activeTab === "reach" && (
                                <div className="sponsor-modal__section" id="reach-panel" role="tabpanel">
                                        ...
                                        <div className="sponsor-roi-callout__grid">
                                            <div className="sponsor-roi-callout__item">
                                                ...
                                                <div className="sponsor-roi-callout__content">
                                                    <span className="sponsor-roi-callout__label">Total Reach</span>
                                                    <strong className="sponsor-roi-callout__value">9M+</strong>
                                                    <span className="sponsor-roi-callout__note">Social impressions</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="sponsor-roi-callout__item">
                                                ...
                                                <div className="sponsor-roi-callout__content">
                                                    <span className="sponsor-roi-callout__label">Audience</span>
                                                    <strong className="sponsor-roi-callout__value">800+</strong>
                                                    <span className="sponsor-roi-callout__note">Engaged builders</span>
                                                </div>
                                            </div>
                                            <div className="sponsor-roi-callout__divider"></div>
                                            <div className="sponsor-roi-callout__item">
                                                ...
                                                <div className="sponsor-roi-callout__content">
                                                    <span className="sponsor-roi-callout__label">Cost Efficiency</span>
                                                    <strong className="sponsor-roi-callout__value">₹0.03</strong>
                                                    <span className="sponsor-roi-callout__note">Cost per reach</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="sponsor-metrics-bars">
                                        <h4 className="sponsor-metrics-bars__title">Platform Reach Breakdown</h4>
                                        <div className="sponsor-platform-grid">
                                            {sponsorshipMetrics.map((metric) => {
                                                ...
                                                return (
                                                    <div key={metric.label} className="sponsor-platform-card">
                                                        <div className="sponsor-platform-card__icon">
                                                            <Icon size={24} />
                                                        </div>
                                                        <div className="sponsor-platform-card__content">
                                                            <span className="sponsor-platform-card__label">{metric.label}</span>
                                                            <span className="sponsor-platform-card__value">{metric.value}</span>
                                                            <span className="sponsor-platform-card__note">{metric.note}</span>
                                                        </div>
                                                    </div>
                                                );
                                            })}
                                    ...
                                    <h4 className="sponsor-modal__subsection-title">Value Proposition</h4>
                                    <div className="sponsor-pillars-grid">
                                        {sponsorshipPillars.map((pillar) => (
                                            <article key={pillar.title} className="sponsor-pillar-card">
                                                <h4>{pillar.title}</h4>
                            ...
                            {activeTab === "influencers" && (
                                <div className="sponsor-modal__section" id="influencers-panel" role="tabpanel">
                                    <h3>Influencer Amplification</h3>
                                    {sponsorshipSections
                                        .filter((s) => s.id === "influencers")
                                        .map((section) => (
                                            <div key={section.id}>
                                                <p className="sponsor-modal__intro">{section.summary}</p>
                                                <div className="influencer-grid">
                                                    {section.details.map((influencer, idx) => (
                                                        <article key={`influencer-${idx}`} className="influencer-card">
                            ...
                            {activeTab === "why" && (
                                <div className="sponsor-modal__section" id="why-panel" role="tabpanel">
                                    <h3>Why Partner with NOESIS</h3>
                                    {sponsorshipSections
                                        .filter((s) => s.id === "why" || s.id === "audience" || s.id === "engagement")
                                        .map((section) => (
                                            <article key={section.id} className="why-card">
                                                ...
                                                <ul>
                                                    {section.details.map((detail, idx) => (
                                                        <li key={`${section.id}-detail-${idx}`}>{detail}</li>
                                                    ))}
                                                </ul>
                                            </article>
                                        ))}
                        ...
                        <footer className="sponsor-modal__footer">
                            <a
                                ...
                                onClick={() => trackEvent('sponsor_cta_click', { cta_type: 'request_deck' })}
                            >
                            ...
                            <a
                                ...
                                onClick={() => trackEvent('sponsor_cta_click', { cta_type: 'schedule_call' })}
                            >
                                Schedule a Call
                            </a>
                        </footer>
